...
TEMPLATES = {
    ...
    "template2": {"file": f"{TEMPLATE_DIR}/template2.png", "x": 400, "y": 320, "size": 70, "color": (0, 51, 102)},
    ...
    "template6": {"file": f"{TEMPLATE_DIR}/template6.png", "x": 400, "y": 330, "size": 70, "color": (0, 0, 0)},
}
